...
This project was inspired by the [OpenZeppelin RehypothecationHook implementation](https://github.com/OpenZeppelin/uniswap-hooks/pull/84/files), but has been reimagined and implemented to align with FlashiFi's thesis and have workable code.
